      ...
      <div className="bg-white/40 backdrop-blur-xl rounded-4xl border border-white/50 p-6 md:p-8 space-y-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-5">
            ...
            <div>
              <p className="font-display text-[9px] font-black uppercase tracking-mega text-primary/30">Directory Imprese</p>
              <h3 className="font-display text-2xl font-black italic tracking-tight text-primary">Ecosistema Cooperative</h3>
            </div>
          </div>
          <div className="bg-white/80 backdrop-blur-md px-4 py-2 rounded-xl border border-white/50 shadow-sm">
             <span className="font-display text-[10px] font-black uppercase tracking-widest-plus text-secondary">
               {filtered.length} realtà matching
             </span>
          </div>
        </div>
